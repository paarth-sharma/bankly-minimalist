...
console.log(25 ** (1 / 2));
console.log(Math.max(2, 8, 23));
console.log(Math.max(2, 5, '1px', 4));
// NaN
console.log(Math.PI);
...
console.log(4854894585893458956398834n);
console.log(BigInt(4854894585893458956398834));

// Exception for using bigint with other datatypes
console.log(20n > 15);
console.log(20n === 20);
